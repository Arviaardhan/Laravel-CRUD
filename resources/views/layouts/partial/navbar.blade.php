    ...
    <div class="container-fluid" style="margin-left: 100px;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(request()->is('student/all')) active @endif" href="/student/all">Students</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if(request()->is('grade/all')) active @endif" href="/grade/all">Grades</a>
                </li>
            </ul>
        </div>
                ...
                @auth
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a class="dropdown-item" href="/dashboard/all">
